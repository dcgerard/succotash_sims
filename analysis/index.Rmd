...
* [Same as above but use RUV + estimate scale using controls + ASH instead of ASH.](diff_alttypes_muscle_plus_ASH_RUV.pdf) RUV + ASH is pretty good at estimating $\pi_0$, but has poor AUC.
